    ...
    <section class="chocolate_section layout_padding">
      <div class="container">
        <div class="heading_container">
          ...
          <p>
            Aysan Doğal İncir olarak, siz değerli müşterilerimize özel olarak sunduğumuz kampanyayı gururla duyuruyoruz. 
            Bu kampanya kapsamında belirli incir çeşitlerinde %20'ye varan indirimler sunulmaktadır. Kampanyadan yararlanmak için 
            aşağıdaki ürünlere göz atabilirsiniz!
          </p>
          
          <div class="container">
            <div class="campaign_container">
              <h2 style="text-align: center; margin-bottom: 20px; color: #4CAF50;">
              ...
              <div class="box">
                ...
                <div class="detail-box">
                  <h6>
                    Bir Numara <span>İncir</span>
                  </h6>
                  <h5>
                    <span class="old-price" style="text-decoration: line-through; color: #d9534f;">499TL</span> 
                    399TL
                  </h5>
                  <a href="">
                    Satın Al
              ...
              <div class="box">
                ...
                <div class="detail-box">
                  <h6>
                    İki Numara <span>İncir</span>
                  </h6>
                  <h5>
                    <span class="old-price" style="text-decoration: line-through; color: #d9534f;">399TL</span> 
                    319TL
                  </h5>
                  <a href="">
                    Satın Al
              ...
              <div class="box">
                ...
                <div class="detail-box">
                  <h6>
                    Üç Numara <span>İncir</span>
                  </h6>
                  <h5>
                    <span class="old-price" style="text-decoration: line-through; color: #d9534f;">299TL</span> 
                    239TL
                  </h5>
                  <a href="">
                    Satın Al
              ...
              <div class="box">
                ...
                <div class="detail-box">
                  ...
                  <h5>
                    <span class="old-price" style="text-decoration: line-through; color: #d9534f;">249TL</span> 
                    199TL
                  </h5>
                  <a href="">
                    Satın Al
              ...
              <div class="box">
                ...
                <div class="detail-box">
                  <h6>
                    Cevizli <span>İncir</span>
                  </h6>
                  <h5>
                    <span class="old-price" style="text-decoration: line-through; color: #d9534f;">249</span> 
                    199TL
                  </h5>
                  <a href="">
                    Satın Al
